...
def _help_pages() -> list[discord.Embed]:
    ...
    e1.add_field(name=".send [.pay] <@user> <amount>", value="Send coins to another user",           inline=True)
    ...
    e4.add_field(name=".gaybar [@user]",   value="Gay-o-meter 🌈",      inline=True)
    e4.add_field(name=".susmeter [@user]", value="Sus meter 📣",        inline=True)
    e4.add_field(name=".nerdrate [@user]", value="Nerd rate 🤓",        inline=True)
